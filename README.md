...
Слот AI-совета (стрим `council`) на экране результата. Дополнительно (этап 9): сравнение, Шепли, экспорт Markdown/PDF, учебные события и история — без изменения формулы Score.
