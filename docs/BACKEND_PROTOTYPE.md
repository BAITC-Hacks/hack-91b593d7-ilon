> Архив: описание раннего прототипа и прежней формулы, до согласования с датасетом организаторов. Приведённые ниже команды и API относятся к удалённой версии `city.v1.json` и больше не подходят для запуска. Актуальные данные и инструкции: [README](../README.md) и [backend/README.md](../backend/README.md).
